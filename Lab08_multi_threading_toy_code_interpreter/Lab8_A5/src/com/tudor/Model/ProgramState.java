...
public class ProgramState {
    ...
    public ProgramState(IStack<Statement> stack, IDict<String, Value> dict, IList<Value> list, IDict<StringValue, BufferedReader> fileDict, IHeap<Integer,Value> heap) {
        stackOfStatements = stack;
        symbolTable = dict;
        outputList = list;
        fileTable = fileDict;
