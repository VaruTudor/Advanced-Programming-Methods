...
import com.tudor.Exceptions.AlreadyDeclared;
...
public class TestDeclarationAndAssignmentStatement {
    ...
    public void shouldDeclareVariable() {
        ...
        ProgramState myProgramState = new ProgramState(executionStack, symbolTable, out, originalProgram);
    ...
    public void shouldFailDeclaration__AlreadyDeclared() {
        ...
        ProgramState myProgramState = new ProgramState(executionStack, symbolTable, out, statementThatShouldPassWhenExecuted);

        statementThatShouldPassWhenExecuted.execute(myProgramState);

        // lambda is used
        Assertions.assertThrows(AlreadyDeclared.class, () -> statementThatShouldFailWhenExecuted.execute(myProgramState),"AlreadyDeclared not thrown");
    }
    ...
    public void shouldAssignValueToAlreadyDeclared() {
        ...
        ProgramState myProgramState = new ProgramState(executionStack, symbolTable, out, statementOfDeclaration);
    ...
    public void shouldFailAssignment__ValueNonDeclared() {
        ...
        ProgramState myProgramState = new ProgramState(executionStack, symbolTable, out, statementOfAssertion);

        // lambda is used
        Assertions.assertThrows(VariableNonDeclared.class, () -> statementOfAssertion.execute(myProgramState),"ValueNonDeclared not thrown");
    }
