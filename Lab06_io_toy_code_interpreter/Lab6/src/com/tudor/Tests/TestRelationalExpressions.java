...
public class TestRelationalExpressions {
    ...
    public void shouldEvaluateSmallerRelationalExpressionAsTrue(){
        ...
        Assertions.assertEquals(expressionAddition.evaluate(notImportantDict), new BoolValue(true));
    }
    ...
    public void shouldEvaluateSmallerRelationalExpressionAsFalse(){
        ...
        Assertions.assertEquals(expressionAddition.evaluate(notImportantDict), new BoolValue(false));
    }
    ...
    public void shouldFailEvaluatingRelationalExpression__OperationNonExistent(){
        ...
        Assertions.assertThrows(OperationNonExistent.class, () -> expressionAddition.evaluate(notImportantDict), "OperationNonExistent not thrown");
    }
    ...
    public void shouldFailEvaluatingRelationalExpression__TypeMismatch(){
        ...
        Assertions.assertThrows(TypeMismatch.class, () -> expressionAddition.evaluate(notImportantDict), "TypeMismatch not thrown");
    }
