...
import com.tudor.Exceptions.ConditionalNotBoolean;
...
public class TestIfStatement {
    ...
    public void shouldDoThenOnIfStatement() {
        ...
        ProgramState myProgramState = new ProgramState(executionStack, symbolTable, out, ifStatement);
    ...
    public void shouldFailIfStatement__ConditionNotBoolean() {
        ...
        Assertions.assertThrows(ConditionalNotBoolean.class, () -> ifStatement.execute(myProgramState), "ConditionNotBoolean not thrown");
    }
}
