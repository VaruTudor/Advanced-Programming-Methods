...
public class TestExpressions {
    ...
    public void shouldFailEvaluatingDivisionArithExpression__TypeMismatch() {
        ...
        Assertions.assertThrows(TypeMismatch.class, () -> expressionDivision.evaluate(notImportantDict), "DivisionByZero not thrown");
    }
    ...
    public void shouldFailEvaluatingLogicExpression__TypeMismatch() {
        ...
        Assertions.assertThrows(TypeMismatch.class, () -> expression.evaluate(notImportantDict), "DivisionByZero not thrown");
    }
