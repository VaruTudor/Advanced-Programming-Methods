...
public class WhileNotStatement implements Statement{
    Expression expression;
    Statement statement;

    public WhileNotStatement(Expression expression, Statement statement) {
    ...
    public ProgramState execute(ProgramState state) {
        ...
        {
            //false
            stack.push(new WhileNotStatement(expression, statement));
