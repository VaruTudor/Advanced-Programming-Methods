...
public class MainWindowController implements Initializable {
    ...
    @FXML
    private TableColumn<Map.Entry<Integer,Map.Entry<Value, List<Value>>>,Integer> indexColumnBarrierTable;

    @FXML
    private TableColumn<Map.Entry<Integer,Map.Entry<Value, List<Value>>>,Integer> valueColumnBarrierTable;

    @FXML
    private TableColumn<Map.Entry<Integer,Map.Entry<Value, List<Value>>>,List<Integer>> listOfValuesColumnBarrierTable;
    ...
    public void populateBarrierTableListView(ProgramState currentProgramState){
        barrierTableView.setItems(FXCollections.observableArrayList(
                new ArrayList<>(
                        currentProgramState.getBarrierTable().getContent().entrySet()
                )
        ));
    ...
    private void updateInterface(ProgramState currentProgramState){
        ...
        try{
            ...
            populateBarrierTableListView(currentProgramState);
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        //TODO setting up the barrier table
        indexColumnBarrierTable.setCellValueFactory(p -> new SimpleIntegerProperty(p.getValue().getKey()).asObject());
        valueColumnBarrierTable.setCellValueFactory(p -> new SimpleIntegerProperty(p.getValue().getKey()).asObject());
